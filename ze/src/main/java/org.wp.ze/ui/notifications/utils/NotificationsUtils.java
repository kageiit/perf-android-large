package org.wp.ze.ui.notifications.utils;
...
import org.wp.ze.ui.comments.CommentActionResult;
import org.wp.ze.ui.comments.CommentActions;
import org.wp.ze.ui.notifications.NotificationEvents.NoteModerationFailed;
import org.wp.ze.ui.notifications.NotificationEvents.NoteModerationStatusChanged;
import org.wp.ze.ui.notifications.NotificationEvents.NoteVisibilityChanged;
import org.wp.ze.ui.notifications.NotificationsDetailActivity;
...
import org.wp.ze.util.DeviceUtils;
import org.wp.ze.util.JSONUtils;
import org.wp.ze.util.helpers.WPImageGetter;
...
//                                note.save();
    ...
    public static boolean isNotificationsEnabled(Context context) {
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            AppOpsManager mAppOps = (AppOpsManager) null;
