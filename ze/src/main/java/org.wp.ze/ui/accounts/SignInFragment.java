...
import org.wp.ze.BuildConfig;
import org.wp.ze.R;
import org.wp.ze.WordPress;
import org.wp.ze.models.Blog;
import org.wp.ze.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ze.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ze.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ze.ui.accounts.helpers.LoginAbstract;
import org.wp.ze.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ze.util.HelpshiftHelper.Tag;
import org.wp.ze.util.JSONUtils;
import org.wp.ze.util.NetworkUtils;
import org.wp.ze.util.StringUtils;
import org.wp.ze.util.ToastUtils;
import org.wp.ze.util.WPUrlUtils;
import org.wp.ze.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ze.R.string.nux_cannot_log_in),
                getString(org.wp.ze.R.string.username_or_password_incorrect),
                org.wp.ze.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ze.R.string.cancel), getString(
                        org.wp.ze.R.string.forgot_password), getString(
                        org.wp.ze.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ze.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ze.R.string.invalid_site_url_message) {
