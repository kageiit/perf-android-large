package org.wp.ze.ui.posts.adapters;
...
import org.wp.ze.ui.posts.PostUtils;
import org.wp.ze.ui.posts.PostsListFragment;
import org.wp.ze.ui.posts.services.PostMediaService;
import org.wp.ze.ui.reader.utils.ReaderImageScanner;
...
public class PostsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PostsListAdapter(Context context,  Blog blog, boolean isPage) {
        mIsPage = isPage;
