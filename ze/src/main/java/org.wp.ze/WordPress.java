...
import org.wp.ze.models.Blog;
import org.wp.ze.networking.RestClientUtils;
import org.wp.ze.ui.ActivityId;
import org.wp.ze.ui.accounts.helpers.UpdateBlogListTask.GenericUpdateBlogListTask;
import org.wp.ze.ui.notifications.utils.NotificationsUtils;
import org.wp.ze.ui.prefs.AppPrefs;
import org.wp.ze.ui.stats.StatsWidgetProvider;
import org.wp.ze.ui.stats.datasets.StatsDatabaseHelper;
import org.wp.ze.ui.stats.datasets.StatsTable;
import org.wp.ze.util.AppLog;
import org.wp.ze.util.AppLog.T;
import org.wp.ze.util.BitmapLruCache;
import org.wp.ze.util.CoreEvents;
import org.wp.ze.util.CoreEvents.UserSignedOutCompletely;
import org.wp.ze.util.CoreEvents.UserSignedOutWordPressCom;
import org.wp.ze.util.DateTimeUtils;
import org.wp.ze.util.HelpshiftHelper;
import org.wp.ze.util.NetworkUtils;
import org.wp.ze.util.PackageUtils;
import org.wp.ze.util.ProfilingUtils;
import org.wp.ze.util.RateLimitedTask;
import org.wp.ze.util.SqlUtils;
import org.wp.ze.util.VolleyUtils;
import org.wp.ze.util.WPActivityUtils;
import org.xmlrpc.ze.ApiHelper;
...
//                    new String[]{"org.wp.ze.ui.ShareIntentReceiverActivity"});
//        }
...
//            OAuthAuthenticator authenticator = OAuthAuthenticatorFactory.instantiate();
            mRestClientUtils = new RestClientUtils(mContext, requestQueue, null, mOnAuthFailedListener);
        }
...
//            OAuthAuthenticator authenticator = OAuthAuthenticatorFactory.instantiate();
            mRestClientUtilsVersion1_1 = new RestClientUtils(mContext, requestQueue, null, mOnAuthFailedListener, RestClient.REST_CLIENT_VERSIONS.V1_1);
        }
...
//            OAuthAuthenticator authenticator = OAuthAuthenticatorFactory.instantiate();
            mRestClientUtilsVersion1_2 = new RestClientUtils(mContext, requestQueue, null, mOnAuthFailedListener, RestClient.REST_CLIENT_VERSIONS.V1_2);
        }
...
//            OAuthAuthenticator authenticator = OAuthAuthenticatorFactory.instantiate();
            mRestClientUtilsVersion1_3 = new RestClientUtils(mContext, requestQueue, null, mOnAuthFailedListener, RestClient.REST_CLIENT_VERSIONS.V1_3);
        }
...
//            OAuthAuthenticator authenticator = OAuthAuthenticatorFactory.instantiate();
            mRestClientUtilsVersion0 = new RestClientUtils(mContext, requestQueue, null, mOnAuthFailedListener, RestClient.REST_CLIENT_VERSIONS.V0);
        }
