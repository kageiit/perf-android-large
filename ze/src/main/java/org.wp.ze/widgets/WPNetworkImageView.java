...
import org.wp.ze.datasets.ReaderThumbnailTable;
...
public class WPNetworkImageView extends AppCompatImageView {
    ...
    public void setDefaultImageResId(int resourceId) {
        mDefaultImageResId = resourceId;
    }

    public void setErrorImageResId(int resourceId) {
