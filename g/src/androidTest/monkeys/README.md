...
## Run
	...
	$ # Example: ./playstore-screenshots.py org.wp.g WordPress-vanilla-release.apk
	$ # Example: ./playstore-screenshots.py org.wp.g.beta WordPress-zbetagroup-release.apk
...
1. Run the script:
	    ...
	    ./playstore-screenshots.py org.wp.g ../../../../WordPress/build/outputs/apk/WordPress-vanilla-release.apk
