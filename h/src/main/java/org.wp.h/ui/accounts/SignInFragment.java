...
import org.wp.h.BuildConfig;
import org.wp.h.R;
import org.wp.h.WordPress;
import org.wp.h.models.Blog;
import org.wp.h.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.h.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.h.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.h.ui.accounts.helpers.LoginAbstract;
import org.wp.h.ui.accounts.helpers.LoginWPCom;
...
import org.wp.h.util.JSONUtils;
import org.wp.h.util.NetworkUtils;
import org.wp.h.util.StringUtils;
import org.wp.h.util.ToastUtils;
import org.wp.h.util.WPUrlUtils;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.h.R.string.nux_cannot_log_in),
                getString(org.wp.h.R.string.username_or_password_incorrect),
                org.wp.h.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.h.R.string.cancel), getString(
                        org.wp.h.R.string.forgot_password), getString(
                        org.wp.h.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.h.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.h.R.string.invalid_site_url_message) {
