package org.wp.h.ui.posts.services;
...
import org.wp.h.models.PostStatus;
import org.wp.h.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.h.ui.posts.PostsListActivity;
import org.wp.h.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.h.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.h.ui.prefs.AppPrefs;
import org.wp.h.util.AppLog;
import org.wp.h.util.AppLog.T;
import org.wp.h.util.CrashlyticsUtils;
import org.wp.h.util.DisplayUtils;
import org.wp.h.util.ImageUtils;
import org.wp.h.util.MediaUtils;
import org.wp.h.util.StringUtils;
import org.wp.h.util.SystemServiceFactory;
import org.wp.h.util.WPMeShortlinks;
import org.wp.h.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.h.ApiHelper;
import org.xmlrpc.h.ApiHelper.Method;
import org.xmlrpc.h.XMLRPCClient;
import org.xmlrpc.h.XMLRPCClientInterface;
import org.xmlrpc.h.XMLRPCException;
import org.xmlrpc.h.XMLRPCFactory;
