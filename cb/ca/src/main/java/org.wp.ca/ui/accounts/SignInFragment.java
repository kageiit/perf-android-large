...
import org.wp.ca.BuildConfig;
import org.wp.ca.R;
import org.wp.ca.WordPress;
import org.wp.ca.models.Blog;
import org.wp.ca.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ca.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ca.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ca.ui.accounts.helpers.LoginAbstract;
import org.wp.ca.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ca.util.HelpshiftHelper.Tag;
import org.wp.ca.util.JSONUtils;
import org.wp.ca.util.NetworkUtils;
import org.wp.ca.util.StringUtils;
import org.wp.ca.util.ToastUtils;
import org.wp.ca.util.WPUrlUtils;
import org.wp.ca.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ca.R.string.nux_cannot_log_in),
                getString(org.wp.ca.R.string.username_or_password_incorrect),
                org.wp.ca.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ca.R.string.cancel), getString(
                        org.wp.ca.R.string.forgot_password), getString(
                        org.wp.ca.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ca.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ca.R.string.invalid_site_url_message) {
