...
import org.wp.za.BuildConfig;
import org.wp.za.R;
import org.wp.za.WordPress;
import org.wp.za.models.Blog;
import org.wp.za.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.za.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.za.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.za.ui.accounts.helpers.LoginAbstract;
import org.wp.za.ui.accounts.helpers.LoginWPCom;
...
import org.wp.za.util.HelpshiftHelper.Tag;
import org.wp.za.util.JSONUtils;
import org.wp.za.util.NetworkUtils;
import org.wp.za.util.StringUtils;
import org.wp.za.util.ToastUtils;
import org.wp.za.util.WPUrlUtils;
import org.wp.za.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.za.R.string.nux_cannot_log_in),
                getString(org.wp.za.R.string.username_or_password_incorrect),
                org.wp.za.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.za.R.string.cancel), getString(
                        org.wp.za.R.string.forgot_password), getString(
                        org.wp.za.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.za.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.za.R.string.invalid_site_url_message) {
