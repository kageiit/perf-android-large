...
import org.wp.ab.BuildConfig;
import org.wp.ab.R;
import org.wp.ab.WordPress;
import org.wp.ab.models.Blog;
import org.wp.ab.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ab.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ab.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ab.ui.accounts.helpers.LoginAbstract;
import org.wp.ab.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ab.util.HelpshiftHelper.Tag;
import org.wp.ab.util.JSONUtils;
import org.wp.ab.util.NetworkUtils;
import org.wp.ab.util.StringUtils;
import org.wp.ab.util.ToastUtils;
import org.wp.ab.util.WPUrlUtils;
import org.wp.ab.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ab.R.string.nux_cannot_log_in),
                getString(org.wp.ab.R.string.username_or_password_incorrect),
                org.wp.ab.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ab.R.string.cancel), getString(
                        org.wp.ab.R.string.forgot_password), getString(
                        org.wp.ab.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ab.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ab.R.string.invalid_site_url_message) {
