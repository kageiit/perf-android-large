...
import org.wp.af.models.Blog;
import org.wp.af.networking.RestClientUtils;
import org.wp.af.ui.ActivityId;
import org.wp.af.ui.accounts.helpers.UpdateBlogListTask.GenericUpdateBlogListTask;
import org.wp.af.ui.notifications.utils.NotificationsUtils;
import org.wp.af.ui.prefs.AppPrefs;
import org.wp.af.ui.stats.StatsWidgetProvider;
import org.wp.af.ui.stats.datasets.StatsDatabaseHelper;
import org.wp.af.ui.stats.datasets.StatsTable;
import org.wp.af.util.AppLog;
import org.wp.af.util.AppLog.T;
import org.wp.af.util.BitmapLruCache;
import org.wp.af.util.CoreEvents;
import org.wp.af.util.CoreEvents.UserSignedOutCompletely;
import org.wp.af.util.CoreEvents.UserSignedOutWordPressCom;
import org.wp.af.util.DateTimeUtils;
import org.wp.af.util.HelpshiftHelper;
import org.wp.af.util.NetworkUtils;
import org.wp.af.util.PackageUtils;
import org.wp.af.util.ProfilingUtils;
import org.wp.af.util.RateLimitedTask;
import org.wp.af.util.SqlUtils;
import org.wp.af.util.VolleyUtils;
import org.wp.af.util.WPActivityUtils;
import org.xmlrpc.af.ApiHelper;
...
//                    new String[]{"org.wp.af.ui.ShareIntentReceiverActivity"});
//        }
