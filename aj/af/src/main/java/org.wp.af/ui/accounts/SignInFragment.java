...
import org.wp.af.BuildConfig;
import org.wp.af.R;
import org.wp.af.WordPress;
import org.wp.af.models.Blog;
import org.wp.af.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.af.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.af.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.af.ui.accounts.helpers.LoginAbstract;
import org.wp.af.ui.accounts.helpers.LoginWPCom;
...
import org.wp.af.util.HelpshiftHelper.Tag;
import org.wp.af.util.JSONUtils;
import org.wp.af.util.NetworkUtils;
import org.wp.af.util.StringUtils;
import org.wp.af.util.ToastUtils;
import org.wp.af.util.WPUrlUtils;
import org.wp.af.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.af.R.string.nux_cannot_log_in),
                getString(org.wp.af.R.string.username_or_password_incorrect),
                org.wp.af.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.af.R.string.cancel), getString(
                        org.wp.af.R.string.forgot_password), getString(
                        org.wp.af.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.af.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.af.R.string.invalid_site_url_message) {
