...
import org.wp.ag.BuildConfig;
import org.wp.ag.R;
import org.wp.ag.WordPress;
import org.wp.ag.models.Blog;
import org.wp.ag.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ag.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ag.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ag.ui.accounts.helpers.LoginAbstract;
import org.wp.ag.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ag.util.HelpshiftHelper.Tag;
import org.wp.ag.util.JSONUtils;
import org.wp.ag.util.NetworkUtils;
import org.wp.ag.util.StringUtils;
import org.wp.ag.util.ToastUtils;
import org.wp.ag.util.WPUrlUtils;
import org.wp.ag.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ag.R.string.nux_cannot_log_in),
                getString(org.wp.ag.R.string.username_or_password_incorrect),
                org.wp.ag.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ag.R.string.cancel), getString(
                        org.wp.ag.R.string.forgot_password), getString(
                        org.wp.ag.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ag.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ag.R.string.invalid_site_url_message) {
