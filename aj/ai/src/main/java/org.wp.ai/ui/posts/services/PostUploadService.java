package org.wp.ai.ui.posts.services;
...
import org.wp.ai.models.PostLocation;
import org.wp.ai.models.PostStatus;
import org.wp.ai.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.ai.ui.posts.PostsListActivity;
import org.wp.ai.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.ai.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.ai.ui.prefs.AppPrefs;
import org.wp.ai.util.AppLog;
import org.wp.ai.util.AppLog.T;
import org.wp.ai.util.CrashlyticsUtils;
import org.wp.ai.util.DisplayUtils;
import org.wp.ai.util.ImageUtils;
import org.wp.ai.util.MediaUtils;
import org.wp.ai.util.StringUtils;
import org.wp.ai.util.SystemServiceFactory;
import org.wp.ai.util.WPMeShortlinks;
import org.wp.ai.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.ai.ApiHelper;
import org.xmlrpc.ai.ApiHelper.Method;
import org.xmlrpc.ai.XMLRPCClient;
import org.xmlrpc.ai.XMLRPCClientInterface;
import org.xmlrpc.ai.XMLRPCException;
import org.xmlrpc.ai.XMLRPCFactory;
