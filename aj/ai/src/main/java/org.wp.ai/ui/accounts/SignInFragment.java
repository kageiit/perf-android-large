...
import org.wp.ai.BuildConfig;
import org.wp.ai.R;
import org.wp.ai.WordPress;
import org.wp.ai.models.Blog;
import org.wp.ai.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ai.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ai.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ai.ui.accounts.helpers.LoginAbstract;
import org.wp.ai.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ai.util.HelpshiftHelper.Tag;
import org.wp.ai.util.JSONUtils;
import org.wp.ai.util.NetworkUtils;
import org.wp.ai.util.StringUtils;
import org.wp.ai.util.ToastUtils;
import org.wp.ai.util.WPUrlUtils;
import org.wp.ai.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ai.R.string.nux_cannot_log_in),
                getString(org.wp.ai.R.string.username_or_password_incorrect),
                org.wp.ai.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ai.R.string.cancel), getString(
                        org.wp.ai.R.string.forgot_password), getString(
                        org.wp.ai.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ai.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ai.R.string.invalid_site_url_message) {
