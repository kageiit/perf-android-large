...
import org.wp.ad.BuildConfig;
import org.wp.ad.R;
import org.wp.ad.WordPress;
import org.wp.ad.models.Blog;
import org.wp.ad.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ad.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ad.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ad.ui.accounts.helpers.LoginAbstract;
import org.wp.ad.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ad.util.HelpshiftHelper.Tag;
import org.wp.ad.util.JSONUtils;
import org.wp.ad.util.NetworkUtils;
import org.wp.ad.util.StringUtils;
import org.wp.ad.util.ToastUtils;
import org.wp.ad.util.WPUrlUtils;
import org.wp.ad.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ad.R.string.nux_cannot_log_in),
                getString(org.wp.ad.R.string.username_or_password_incorrect),
                org.wp.ad.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ad.R.string.cancel), getString(
                        org.wp.ad.R.string.forgot_password), getString(
                        org.wp.ad.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ad.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ad.R.string.invalid_site_url_message) {
