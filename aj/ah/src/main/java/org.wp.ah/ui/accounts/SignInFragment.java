...
import org.wp.ah.BuildConfig;
import org.wp.ah.R;
import org.wp.ah.WordPress;
import org.wp.ah.models.Blog;
import org.wp.ah.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ah.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ah.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ah.ui.accounts.helpers.LoginAbstract;
import org.wp.ah.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ah.util.HelpshiftHelper.Tag;
import org.wp.ah.util.JSONUtils;
import org.wp.ah.util.NetworkUtils;
import org.wp.ah.util.StringUtils;
import org.wp.ah.util.ToastUtils;
import org.wp.ah.util.WPUrlUtils;
import org.wp.ah.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ah.R.string.nux_cannot_log_in),
                getString(org.wp.ah.R.string.username_or_password_incorrect),
                org.wp.ah.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ah.R.string.cancel), getString(
                        org.wp.ah.R.string.forgot_password), getString(
                        org.wp.ah.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ah.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ah.R.string.invalid_site_url_message) {
