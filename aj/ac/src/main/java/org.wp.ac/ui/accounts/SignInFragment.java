...
import org.wp.ac.BuildConfig;
import org.wp.ac.R;
import org.wp.ac.WordPress;
import org.wp.ac.models.Blog;
import org.wp.ac.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ac.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ac.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ac.ui.accounts.helpers.LoginAbstract;
import org.wp.ac.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ac.util.HelpshiftHelper.Tag;
import org.wp.ac.util.JSONUtils;
import org.wp.ac.util.NetworkUtils;
import org.wp.ac.util.StringUtils;
import org.wp.ac.util.ToastUtils;
import org.wp.ac.util.WPUrlUtils;
import org.wp.ac.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ac.R.string.nux_cannot_log_in),
                getString(org.wp.ac.R.string.username_or_password_incorrect),
                org.wp.ac.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ac.R.string.cancel), getString(
                        org.wp.ac.R.string.forgot_password), getString(
                        org.wp.ac.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ac.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ac.R.string.invalid_site_url_message) {
