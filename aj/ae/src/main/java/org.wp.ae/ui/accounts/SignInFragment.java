...
import org.wp.ae.BuildConfig;
import org.wp.ae.R;
import org.wp.ae.WordPress;
import org.wp.ae.models.Blog;
import org.wp.ae.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ae.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ae.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ae.ui.accounts.helpers.LoginAbstract;
import org.wp.ae.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ae.util.HelpshiftHelper.Tag;
import org.wp.ae.util.JSONUtils;
import org.wp.ae.util.NetworkUtils;
import org.wp.ae.util.StringUtils;
import org.wp.ae.util.ToastUtils;
import org.wp.ae.util.WPUrlUtils;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ae.R.string.nux_cannot_log_in),
                getString(org.wp.ae.R.string.username_or_password_incorrect),
                org.wp.ae.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ae.R.string.cancel), getString(
                        org.wp.ae.R.string.forgot_password), getString(
                        org.wp.ae.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ae.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ae.R.string.invalid_site_url_message) {
