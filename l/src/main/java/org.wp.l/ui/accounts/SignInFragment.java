...
import org.wp.l.BuildConfig;
import org.wp.l.R;
import org.wp.l.WordPress;
import org.wp.l.models.Blog;
import org.wp.l.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.l.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.l.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.l.ui.accounts.helpers.LoginAbstract;
import org.wp.l.ui.accounts.helpers.LoginWPCom;
...
import org.wp.l.util.HelpshiftHelper.Tag;
import org.wp.l.util.JSONUtils;
import org.wp.l.util.NetworkUtils;
import org.wp.l.util.StringUtils;
import org.wp.l.util.ToastUtils;
import org.wp.l.util.WPUrlUtils;
import org.wp.l.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.l.R.string.nux_cannot_log_in),
                getString(org.wp.l.R.string.username_or_password_incorrect),
                org.wp.l.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.l.R.string.cancel), getString(
                        org.wp.l.R.string.forgot_password), getString(
                        org.wp.l.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.l.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.l.R.string.invalid_site_url_message) {
