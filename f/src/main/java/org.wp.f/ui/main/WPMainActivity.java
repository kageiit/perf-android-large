...
import org.wp.f.GCMMessageService;
import org.wp.f.GCMRegistrationIntentService;
import org.wp.f.R;
import org.wp.f.WordPress;
import org.wp.f.models.AccountHelper;
import org.wp.f.models.Blog;
import org.wp.f.ui.ActivityId;
import org.wp.f.ui.ActivityLauncher;
import org.wp.f.ui.RequestCodes;
import org.wp.f.ui.accounts.login.MagicLinkSignInActivity;
import org.wp.f.ui.notifications.NotificationEvents;
import org.wp.f.ui.notifications.NotificationsListFragment;
import org.wp.f.ui.notifications.utils.NotificationsUtils;
import org.wp.f.ui.posts.PromoDialog;
import org.wp.f.ui.prefs.AppPrefs;
import org.wp.f.ui.prefs.AppSettingsFragment;
import org.wp.f.ui.prefs.SiteSettingsFragment;
import org.wp.f.ui.reader.ReaderPostListFragment;
import org.wp.f.util.AniUtils;
import org.wp.f.util.AppLog;
import org.wp.f.util.AppLog.T;
import org.wp.f.util.AuthenticationDialogUtils;
import org.wp.f.util.CoreEvents;
import org.wp.f.util.CoreEvents.MainViewPagerScrolled;
...
import org.wp.f.widgets.WPViewPager;
