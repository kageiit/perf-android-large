package org.wp.f.ui.posts.services;
...
import org.wp.f.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.f.ui.posts.PostsListActivity;
import org.wp.f.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.f.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.f.ui.prefs.AppPrefs;
import org.wp.f.util.AppLog;
import org.wp.f.util.AppLog.T;
import org.wp.f.util.CrashlyticsUtils;
import org.wp.f.util.DisplayUtils;
import org.wp.f.util.ImageUtils;
import org.wp.f.util.MediaUtils;
import org.wp.f.util.StringUtils;
import org.wp.f.util.SystemServiceFactory;
import org.wp.f.util.WPMeShortlinks;
import org.wp.f.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.f.ApiHelper;
import org.xmlrpc.f.ApiHelper.Method;
import org.xmlrpc.f.XMLRPCClient;
