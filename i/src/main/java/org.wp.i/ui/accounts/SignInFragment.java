...
import org.wp.i.BuildConfig;
import org.wp.i.R;
import org.wp.i.WordPress;
import org.wp.i.models.Blog;
import org.wp.i.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.i.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.i.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.i.ui.accounts.helpers.LoginAbstract;
import org.wp.i.ui.accounts.helpers.LoginWPCom;
...
import org.wp.i.util.HelpshiftHelper.Tag;
import org.wp.i.util.JSONUtils;
import org.wp.i.util.NetworkUtils;
import org.wp.i.util.StringUtils;
import org.wp.i.util.ToastUtils;
import org.wp.i.util.WPUrlUtils;
import org.wp.i.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.i.R.string.nux_cannot_log_in),
                getString(org.wp.i.R.string.username_or_password_incorrect),
                org.wp.i.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.i.R.string.cancel), getString(
                        org.wp.i.R.string.forgot_password), getString(
                        org.wp.i.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.i.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.i.R.string.invalid_site_url_message) {
