package org.wp.p.ui.posts.services;
...
import org.wp.p.models.PostLocation;
import org.wp.p.models.PostStatus;
import org.wp.p.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.p.ui.posts.PostsListActivity;
import org.wp.p.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.p.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.p.ui.prefs.AppPrefs;
import org.wp.p.util.AppLog;
import org.wp.p.util.AppLog.T;
import org.wp.p.util.CrashlyticsUtils;
import org.wp.p.util.DisplayUtils;
import org.wp.p.util.ImageUtils;
import org.wp.p.util.MediaUtils;
import org.wp.p.util.StringUtils;
import org.wp.p.util.SystemServiceFactory;
import org.wp.p.util.WPMeShortlinks;
import org.wp.p.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.p.ApiHelper;
import org.xmlrpc.p.ApiHelper.Method;
import org.xmlrpc.p.XMLRPCClient;
import org.xmlrpc.p.XMLRPCClientInterface;
import org.xmlrpc.p.XMLRPCException;
import org.xmlrpc.p.XMLRPCFactory;
