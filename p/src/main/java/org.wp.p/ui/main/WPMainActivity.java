...
import org.wp.p.GCMMessageService;
import org.wp.p.GCMRegistrationIntentService;
import org.wp.p.R;
import org.wp.p.WordPress;
import org.wp.p.models.AccountHelper;
import org.wp.p.models.Blog;
import org.wp.p.ui.ActivityId;
import org.wp.p.ui.ActivityLauncher;
import org.wp.p.ui.RequestCodes;
import org.wp.p.ui.accounts.login.MagicLinkSignInActivity;
import org.wp.p.ui.notifications.NotificationEvents;
import org.wp.p.ui.notifications.NotificationsListFragment;
import org.wp.p.ui.notifications.utils.NotificationsUtils;
import org.wp.p.ui.posts.PromoDialog;
import org.wp.p.ui.prefs.AppPrefs;
import org.wp.p.ui.prefs.AppSettingsFragment;
import org.wp.p.ui.prefs.SiteSettingsFragment;
import org.wp.p.ui.reader.ReaderPostListFragment;
import org.wp.p.util.AniUtils;
import org.wp.p.util.AppLog;
import org.wp.p.util.AppLog.T;
import org.wp.p.util.AuthenticationDialogUtils;
import org.wp.p.util.CoreEvents;
import org.wp.p.util.CoreEvents.MainViewPagerScrolled;
...
import org.wp.p.widgets.WPViewPager;
