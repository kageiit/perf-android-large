...
import org.wp.b.BuildConfig;
import org.wp.b.R;
import org.wp.b.WordPress;
import org.wp.b.models.Blog;
import org.wp.b.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.b.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.b.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.b.ui.accounts.helpers.LoginAbstract;
import org.wp.b.ui.accounts.helpers.LoginWPCom;
...
import org.wp.b.util.HelpshiftHelper.Tag;
import org.wp.b.util.JSONUtils;
import org.wp.b.util.NetworkUtils;
import org.wp.b.util.StringUtils;
import org.wp.b.util.ToastUtils;
import org.wp.b.util.WPUrlUtils;
import org.wp.b.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.b.R.string.nux_cannot_log_in),
                getString(org.wp.b.R.string.username_or_password_incorrect),
                org.wp.b.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.b.R.string.cancel), getString(
                        org.wp.b.R.string.forgot_password), getString(
                        org.wp.b.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.b.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.b.R.string.invalid_site_url_message) {
