package org.wp.x.ui.posts.services;
...
import org.wp.x.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.x.ui.posts.PostsListActivity;
import org.wp.x.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.x.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.x.ui.prefs.AppPrefs;
import org.wp.x.util.AppLog;
import org.wp.x.util.AppLog.T;
import org.wp.x.util.CrashlyticsUtils;
import org.wp.x.util.DisplayUtils;
import org.wp.x.util.ImageUtils;
import org.wp.x.util.MediaUtils;
import org.wp.x.util.StringUtils;
import org.wp.x.util.SystemServiceFactory;
import org.wp.x.util.WPMeShortlinks;
import org.wp.x.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.x.ApiHelper;
import org.xmlrpc.x.ApiHelper.Method;
import org.xmlrpc.x.XMLRPCClient;
import org.xmlrpc.x.XMLRPCClientInterface;
import org.xmlrpc.x.XMLRPCException;
