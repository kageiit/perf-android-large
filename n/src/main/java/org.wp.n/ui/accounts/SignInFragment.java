...
import org.wp.n.BuildConfig;
import org.wp.n.R;
import org.wp.n.WordPress;
import org.wp.n.models.Blog;
import org.wp.n.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.n.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.n.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.n.ui.accounts.helpers.LoginAbstract;
import org.wp.n.ui.accounts.helpers.LoginWPCom;
...
import org.wp.n.util.HelpshiftHelper.Tag;
import org.wp.n.util.JSONUtils;
import org.wp.n.util.NetworkUtils;
import org.wp.n.util.StringUtils;
import org.wp.n.util.ToastUtils;
import org.wp.n.util.WPUrlUtils;
import org.wp.n.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.n.R.string.nux_cannot_log_in),
                getString(org.wp.n.R.string.username_or_password_incorrect),
                org.wp.n.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.n.R.string.cancel), getString(
                        org.wp.n.R.string.forgot_password), getString(
                        org.wp.n.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.n.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.n.R.string.invalid_site_url_message) {
