...
import org.wp.dh.BuildConfig;
import org.wp.dh.R;
import org.wp.dh.WordPress;
import org.wp.dh.models.Blog;
import org.wp.dh.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.dh.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.dh.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.dh.ui.accounts.helpers.LoginAbstract;
import org.wp.dh.ui.accounts.helpers.LoginWPCom;
...
import org.wp.dh.util.StringUtils;
import org.wp.dh.util.ToastUtils;
import org.wp.dh.util.WPUrlUtils;
import org.wp.dh.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.dh.R.string.nux_cannot_log_in),
                getString(org.wp.dh.R.string.username_or_password_incorrect),
                org.wp.dh.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.dh.R.string.cancel), getString(
                        org.wp.dh.R.string.forgot_password), getString(
                        org.wp.dh.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.dh.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.dh.R.string.invalid_site_url_message) {
