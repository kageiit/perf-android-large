package org.wp.dh.ui.posts.services;
...
import org.wp.dh.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.dh.ui.posts.PostsListActivity;
import org.wp.dh.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.dh.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.dh.ui.prefs.AppPrefs;
import org.wp.dh.util.AppLog;
import org.wp.dh.util.AppLog.T;
import org.wp.dh.util.CrashlyticsUtils;
import org.wp.dh.util.DisplayUtils;
import org.wp.dh.util.ImageUtils;
import org.wp.dh.util.MediaUtils;
import org.wp.dh.util.StringUtils;
import org.wp.dh.util.SystemServiceFactory;
import org.wp.dh.util.WPMeShortlinks;
import org.wp.dh.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.dh.ApiHelper;
import org.xmlrpc.dh.ApiHelper.Method;
import org.xmlrpc.dh.XMLRPCClient;
import org.xmlrpc.dh.XMLRPCClientInterface;
import org.xmlrpc.dh.XMLRPCException;
