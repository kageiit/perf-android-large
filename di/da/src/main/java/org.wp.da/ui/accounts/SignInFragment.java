...
import org.wp.da.BuildConfig;
import org.wp.da.R;
import org.wp.da.WordPress;
import org.wp.da.models.Blog;
import org.wp.da.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.da.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.da.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.da.ui.accounts.helpers.LoginAbstract;
import org.wp.da.ui.accounts.helpers.LoginWPCom;
...
import org.wp.da.util.HelpshiftHelper.Tag;
import org.wp.da.util.JSONUtils;
import org.wp.da.util.NetworkUtils;
import org.wp.da.util.StringUtils;
import org.wp.da.util.ToastUtils;
import org.wp.da.util.WPUrlUtils;
import org.wp.da.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.da.R.string.nux_cannot_log_in),
                getString(org.wp.da.R.string.username_or_password_incorrect),
                org.wp.da.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.da.R.string.cancel), getString(
                        org.wp.da.R.string.forgot_password), getString(
                        org.wp.da.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.da.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.da.R.string.invalid_site_url_message) {
