package org.wp.u.ui.posts.services;
...
import org.wp.u.models.PostStatus;
import org.wp.u.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.u.ui.posts.PostsListActivity;
import org.wp.u.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.u.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.u.ui.prefs.AppPrefs;
import org.wp.u.util.AppLog;
import org.wp.u.util.AppLog.T;
import org.wp.u.util.CrashlyticsUtils;
import org.wp.u.util.DisplayUtils;
import org.wp.u.util.ImageUtils;
import org.wp.u.util.MediaUtils;
import org.wp.u.util.StringUtils;
import org.wp.u.util.SystemServiceFactory;
import org.wp.u.util.WPMeShortlinks;
import org.wp.u.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.u.ApiHelper;
import org.xmlrpc.u.ApiHelper.Method;
import org.xmlrpc.u.XMLRPCClient;
import org.xmlrpc.u.XMLRPCClientInterface;
import org.xmlrpc.u.XMLRPCException;
import org.xmlrpc.u.XMLRPCFactory;
