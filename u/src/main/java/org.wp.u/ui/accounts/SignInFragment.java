...
import org.wp.u.BuildConfig;
import org.wp.u.R;
import org.wp.u.WordPress;
import org.wp.u.models.Blog;
import org.wp.u.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.u.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.u.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.u.ui.accounts.helpers.LoginAbstract;
import org.wp.u.ui.accounts.helpers.LoginWPCom;
...
import org.wp.u.util.HelpshiftHelper.Tag;
import org.wp.u.util.JSONUtils;
import org.wp.u.util.NetworkUtils;
import org.wp.u.util.StringUtils;
import org.wp.u.util.ToastUtils;
import org.wp.u.util.WPUrlUtils;
import org.wp.u.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.u.R.string.nux_cannot_log_in),
                getString(org.wp.u.R.string.username_or_password_incorrect),
                org.wp.u.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.u.R.string.cancel), getString(
                        org.wp.u.R.string.forgot_password), getString(
                        org.wp.u.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.u.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.u.R.string.invalid_site_url_message) {
