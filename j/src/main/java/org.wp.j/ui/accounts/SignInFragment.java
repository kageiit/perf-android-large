...
import org.wp.j.BuildConfig;
import org.wp.j.R;
import org.wp.j.WordPress;
import org.wp.j.models.Blog;
import org.wp.j.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.j.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.j.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.j.ui.accounts.helpers.LoginAbstract;
import org.wp.j.ui.accounts.helpers.LoginWPCom;
...
import org.wp.j.util.HelpshiftHelper.Tag;
import org.wp.j.util.JSONUtils;
import org.wp.j.util.NetworkUtils;
import org.wp.j.util.StringUtils;
import org.wp.j.util.ToastUtils;
import org.wp.j.util.WPUrlUtils;
import org.wp.j.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.j.R.string.nux_cannot_log_in),
                getString(org.wp.j.R.string.username_or_password_incorrect),
                org.wp.j.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.j.R.string.cancel), getString(
                        org.wp.j.R.string.forgot_password), getString(
                        org.wp.j.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.j.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.j.R.string.invalid_site_url_message) {
