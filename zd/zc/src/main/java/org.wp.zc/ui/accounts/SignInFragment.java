...
import org.wp.zc.BuildConfig;
import org.wp.zc.R;
import org.wp.zc.WordPress;
import org.wp.zc.models.Blog;
import org.wp.zc.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.zc.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.zc.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.zc.ui.accounts.helpers.LoginAbstract;
import org.wp.zc.ui.accounts.helpers.LoginWPCom;
...
import org.wp.zc.util.WPUrlUtils;
import org.wp.zc.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.zc.R.string.nux_cannot_log_in),
                getString(org.wp.zc.R.string.username_or_password_incorrect),
                org.wp.zc.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.zc.R.string.cancel), getString(
                        org.wp.zc.R.string.forgot_password), getString(
                        org.wp.zc.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.zc.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.zc.R.string.invalid_site_url_message) {
