...
import org.wp.zb.BuildConfig;
import org.wp.zb.R;
import org.wp.zb.WordPress;
import org.wp.zb.models.Blog;
import org.wp.zb.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.zb.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.zb.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.zb.ui.accounts.helpers.LoginAbstract;
import org.wp.zb.ui.accounts.helpers.LoginWPCom;
...
import org.wp.zb.util.HelpshiftHelper.Tag;
import org.wp.zb.util.JSONUtils;
import org.wp.zb.util.NetworkUtils;
import org.wp.zb.util.StringUtils;
import org.wp.zb.util.ToastUtils;
import org.wp.zb.util.WPUrlUtils;
import org.wp.zb.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.zb.R.string.nux_cannot_log_in),
                getString(org.wp.zb.R.string.username_or_password_incorrect),
                org.wp.zb.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.zb.R.string.cancel), getString(
                        org.wp.zb.R.string.forgot_password), getString(
                        org.wp.zb.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.zb.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.zb.R.string.invalid_site_url_message) {
