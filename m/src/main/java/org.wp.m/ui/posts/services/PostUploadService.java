package org.wp.m.ui.posts.services;
...
import org.wp.m.models.PostLocation;
import org.wp.m.models.PostStatus;
import org.wp.m.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.m.ui.posts.PostsListActivity;
import org.wp.m.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.m.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.m.ui.prefs.AppPrefs;
import org.wp.m.util.AppLog;
import org.wp.m.util.AppLog.T;
import org.wp.m.util.CrashlyticsUtils;
import org.wp.m.util.DisplayUtils;
import org.wp.m.util.ImageUtils;
import org.wp.m.util.MediaUtils;
import org.wp.m.util.StringUtils;
import org.wp.m.util.SystemServiceFactory;
import org.wp.m.util.WPMeShortlinks;
import org.wp.m.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.m.ApiHelper;
import org.xmlrpc.m.ApiHelper.Method;
import org.xmlrpc.m.XMLRPCClient;
import org.xmlrpc.m.XMLRPCClientInterface;
import org.xmlrpc.m.XMLRPCException;
import org.xmlrpc.m.XMLRPCFactory;
