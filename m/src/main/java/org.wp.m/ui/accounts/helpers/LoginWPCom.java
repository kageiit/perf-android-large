package org.wp.m.ui.accounts.helpers;
...
public class LoginWPCom extends LoginAbstract {
    ...
    public static int restLoginErrorToMsgId(JSONObject errorObject) {
        ...
        int errorMsgId = org.wp.m.R.string.nux_cannot_log_in;
            ...
            try {
                ...
                if (error.equals("invalid_request")) {
                    if (errorDescription.contains("Incorrect username or password.")) {
                        errorMsgId = org.wp.m.R.string.username_or_password_incorrect;
                    }
                } else if (error.equals("needs_2fa")) {
                    errorMsgId = org.wp.m.R.string.account_two_step_auth_enabled;
                } else if (error.equals("invalid_otp")) {
                    errorMsgId = org.wp.m.R.string.invalid_verification_code;
                }
