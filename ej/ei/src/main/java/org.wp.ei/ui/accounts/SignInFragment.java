...
import org.wp.ei.BuildConfig;
import org.wp.ei.R;
import org.wp.ei.WordPress;
import org.wp.ei.models.Blog;
import org.wp.ei.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ei.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ei.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ei.ui.accounts.helpers.LoginAbstract;
import org.wp.ei.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ei.util.HelpshiftHelper.Tag;
import org.wp.ei.util.JSONUtils;
import org.wp.ei.util.NetworkUtils;
import org.wp.ei.util.StringUtils;
import org.wp.ei.util.ToastUtils;
import org.wp.ei.util.WPUrlUtils;
import org.wp.ei.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ei.R.string.nux_cannot_log_in),
                getString(org.wp.ei.R.string.username_or_password_incorrect),
                org.wp.ei.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ei.R.string.cancel), getString(
                        org.wp.ei.R.string.forgot_password), getString(
                        org.wp.ei.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ei.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ei.R.string.invalid_site_url_message) {
