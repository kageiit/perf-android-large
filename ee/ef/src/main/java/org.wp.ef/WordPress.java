...
import org.wp.ef.datasets.ReaderDatabase;
import org.wp.ef.models.AccountHelper;
import org.wp.ef.models.Blog;
import org.wp.ef.networking.RestClientUtils;
import org.wp.ef.ui.ActivityId;
import org.wp.ef.ui.accounts.helpers.UpdateBlogListTask.GenericUpdateBlogListTask;
import org.wp.ef.ui.notifications.utils.NotificationsUtils;
import org.wp.ef.ui.prefs.AppPrefs;
import org.wp.ef.ui.stats.StatsWidgetProvider;
import org.wp.ef.ui.stats.datasets.StatsDatabaseHelper;
import org.wp.ef.ui.stats.datasets.StatsTable;
import org.wp.ef.util.AppLog;
import org.wp.ef.util.AppLog.T;
import org.wp.ef.util.BitmapLruCache;
import org.wp.ef.util.CoreEvents;
import org.wp.ef.util.CoreEvents.UserSignedOutCompletely;
import org.wp.ef.util.CoreEvents.UserSignedOutWordPressCom;
import org.wp.ef.util.DateTimeUtils;
import org.wp.ef.util.HelpshiftHelper;
import org.wp.ef.util.NetworkUtils;
import org.wp.ef.util.PackageUtils;
import org.wp.ef.util.ProfilingUtils;
import org.wp.ef.util.RateLimitedTask;
import org.wp.ef.util.SqlUtils;
import org.wp.ef.util.VolleyUtils;
import org.wp.ef.util.WPActivityUtils;
import org.xmlrpc.ef.ApiHelper;
...
//                    new String[]{"org.wp.ef.ui.ShareIntentReceiverActivity"});
//        }
