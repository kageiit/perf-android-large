...
import org.wp.ef.BuildConfig;
import org.wp.ef.R;
import org.wp.ef.WordPress;
import org.wp.ef.models.Blog;
import org.wp.ef.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ef.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ef.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ef.ui.accounts.helpers.LoginAbstract;
import org.wp.ef.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ef.util.HelpshiftHelper.Tag;
import org.wp.ef.util.JSONUtils;
import org.wp.ef.util.NetworkUtils;
import org.wp.ef.util.StringUtils;
import org.wp.ef.util.ToastUtils;
import org.wp.ef.util.WPUrlUtils;
import org.wp.ef.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ef.R.string.nux_cannot_log_in),
                getString(org.wp.ef.R.string.username_or_password_incorrect),
                org.wp.ef.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ef.R.string.cancel), getString(
                        org.wp.ef.R.string.forgot_password), getString(
                        org.wp.ef.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ef.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ef.R.string.invalid_site_url_message) {
