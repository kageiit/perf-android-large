...
import org.wp.eg.BuildConfig;
import org.wp.eg.R;
import org.wp.eg.WordPress;
import org.wp.eg.models.Blog;
import org.wp.eg.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.eg.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.eg.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.eg.ui.accounts.helpers.LoginAbstract;
import org.wp.eg.ui.accounts.helpers.LoginWPCom;
...
import org.wp.eg.util.HelpshiftHelper.Tag;
import org.wp.eg.util.JSONUtils;
import org.wp.eg.util.NetworkUtils;
import org.wp.eg.util.StringUtils;
import org.wp.eg.util.ToastUtils;
import org.wp.eg.util.WPUrlUtils;
import org.wp.eg.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.eg.R.string.nux_cannot_log_in),
                getString(org.wp.eg.R.string.username_or_password_incorrect),
                org.wp.eg.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.eg.R.string.cancel), getString(
                        org.wp.eg.R.string.forgot_password), getString(
                        org.wp.eg.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.eg.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.eg.R.string.invalid_site_url_message) {
