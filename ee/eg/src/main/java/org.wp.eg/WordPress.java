...
import org.wp.eg.models.Blog;
import org.wp.eg.networking.RestClientUtils;
import org.wp.eg.ui.ActivityId;
import org.wp.eg.ui.accounts.helpers.UpdateBlogListTask.GenericUpdateBlogListTask;
import org.wp.eg.ui.notifications.utils.NotificationsUtils;
import org.wp.eg.ui.prefs.AppPrefs;
import org.wp.eg.ui.stats.StatsWidgetProvider;
import org.wp.eg.ui.stats.datasets.StatsDatabaseHelper;
import org.wp.eg.ui.stats.datasets.StatsTable;
import org.wp.eg.util.AppLog;
import org.wp.eg.util.AppLog.T;
import org.wp.eg.util.BitmapLruCache;
import org.wp.eg.util.CoreEvents;
import org.wp.eg.util.CoreEvents.UserSignedOutCompletely;
import org.wp.eg.util.CoreEvents.UserSignedOutWordPressCom;
import org.wp.eg.util.DateTimeUtils;
import org.wp.eg.util.HelpshiftHelper;
import org.wp.eg.util.NetworkUtils;
import org.wp.eg.util.PackageUtils;
import org.wp.eg.util.ProfilingUtils;
import org.wp.eg.util.RateLimitedTask;
import org.wp.eg.util.SqlUtils;
import org.wp.eg.util.VolleyUtils;
import org.wp.eg.util.WPActivityUtils;
import org.xmlrpc.eg.ApiHelper;
...
//                    new String[]{"org.wp.eg.ui.ShareIntentReceiverActivity"});
//        }
