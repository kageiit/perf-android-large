...
import org.wp.e.BuildConfig;
import org.wp.e.R;
import org.wp.e.WordPress;
import org.wp.e.models.Blog;
import org.wp.e.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.e.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.e.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.e.ui.accounts.helpers.LoginAbstract;
import org.wp.e.ui.accounts.helpers.LoginWPCom;
...
import org.wp.e.util.HelpshiftHelper.Tag;
import org.wp.e.util.JSONUtils;
import org.wp.e.util.NetworkUtils;
import org.wp.e.util.StringUtils;
import org.wp.e.util.ToastUtils;
import org.wp.e.util.WPUrlUtils;
import org.wp.e.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.e.R.string.nux_cannot_log_in),
                getString(org.wp.e.R.string.username_or_password_incorrect),
                org.wp.e.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.e.R.string.cancel), getString(
                        org.wp.e.R.string.forgot_password), getString(
                        org.wp.e.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.e.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.e.R.string.invalid_site_url_message) {
