package org.wp.r.ui.posts.services;
...
import org.wp.r.models.PostLocation;
import org.wp.r.models.PostStatus;
import org.wp.r.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.r.ui.posts.PostsListActivity;
import org.wp.r.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.r.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.r.ui.prefs.AppPrefs;
import org.wp.r.util.AppLog;
import org.wp.r.util.AppLog.T;
import org.wp.r.util.CrashlyticsUtils;
import org.wp.r.util.DisplayUtils;
import org.wp.r.util.ImageUtils;
import org.wp.r.util.MediaUtils;
import org.wp.r.util.StringUtils;
import org.wp.r.util.SystemServiceFactory;
import org.wp.r.util.WPMeShortlinks;
import org.wp.r.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.r.ApiHelper;
import org.xmlrpc.r.ApiHelper.Method;
import org.xmlrpc.r.XMLRPCClient;
import org.xmlrpc.r.XMLRPCClientInterface;
import org.xmlrpc.r.XMLRPCException;
import org.xmlrpc.r.XMLRPCFactory;
