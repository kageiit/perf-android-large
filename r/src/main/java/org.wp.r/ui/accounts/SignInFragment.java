...
import org.wp.r.BuildConfig;
import org.wp.r.R;
import org.wp.r.WordPress;
import org.wp.r.models.Blog;
import org.wp.r.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.r.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.r.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.r.ui.accounts.helpers.LoginAbstract;
import org.wp.r.ui.accounts.helpers.LoginWPCom;
...
import org.wp.r.util.HelpshiftHelper.Tag;
import org.wp.r.util.JSONUtils;
import org.wp.r.util.NetworkUtils;
import org.wp.r.util.StringUtils;
import org.wp.r.util.ToastUtils;
import org.wp.r.util.WPUrlUtils;
import org.wp.r.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.r.R.string.nux_cannot_log_in),
                getString(org.wp.r.R.string.username_or_password_incorrect),
                org.wp.r.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.r.R.string.cancel), getString(
                        org.wp.r.R.string.forgot_password), getString(
                        org.wp.r.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.r.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.r.R.string.invalid_site_url_message) {
