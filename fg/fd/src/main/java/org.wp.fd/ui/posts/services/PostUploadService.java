package org.wp.fd.ui.posts.services;
...
import org.wp.fd.models.PostLocation;
import org.wp.fd.models.PostStatus;
import org.wp.fd.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.fd.ui.posts.PostsListActivity;
import org.wp.fd.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.fd.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.fd.ui.prefs.AppPrefs;
import org.wp.fd.util.AppLog;
import org.wp.fd.util.AppLog.T;
import org.wp.fd.util.CrashlyticsUtils;
import org.wp.fd.util.DisplayUtils;
import org.wp.fd.util.ImageUtils;
import org.wp.fd.util.MediaUtils;
import org.wp.fd.util.StringUtils;
import org.wp.fd.util.SystemServiceFactory;
import org.wp.fd.util.WPMeShortlinks;
import org.wp.fd.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.fd.ApiHelper;
import org.xmlrpc.fd.ApiHelper.Method;
import org.xmlrpc.fd.XMLRPCClient;
import org.xmlrpc.fd.XMLRPCClientInterface;
import org.xmlrpc.fd.XMLRPCException;
import org.xmlrpc.fd.XMLRPCFactory;
