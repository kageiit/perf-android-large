...
import org.wp.fd.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.fd.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.fd.ui.accounts.helpers.LoginAbstract;
import org.wp.fd.ui.accounts.helpers.LoginWPCom;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.fd.R.string.nux_cannot_log_in),
                getString(org.wp.fd.R.string.username_or_password_incorrect),
                org.wp.fd.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.fd.R.string.cancel), getString(
                        org.wp.fd.R.string.forgot_password), getString(
                        org.wp.fd.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.fd.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.fd.R.string.invalid_site_url_message) {
