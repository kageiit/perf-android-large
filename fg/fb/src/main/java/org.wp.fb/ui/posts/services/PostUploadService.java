package org.wp.fb.ui.posts.services;
...
import org.wp.fb.models.PostStatus;
import org.wp.fb.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.fb.ui.posts.PostsListActivity;
import org.wp.fb.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.fb.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.fb.ui.prefs.AppPrefs;
import org.wp.fb.util.AppLog;
import org.wp.fb.util.AppLog.T;
import org.wp.fb.util.CrashlyticsUtils;
import org.wp.fb.util.DisplayUtils;
import org.wp.fb.util.ImageUtils;
import org.wp.fb.util.MediaUtils;
import org.wp.fb.util.StringUtils;
import org.wp.fb.util.SystemServiceFactory;
import org.wp.fb.util.WPMeShortlinks;
import org.wp.fb.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.fb.ApiHelper;
import org.xmlrpc.fb.ApiHelper.Method;
import org.xmlrpc.fb.XMLRPCClient;
import org.xmlrpc.fb.XMLRPCClientInterface;
import org.xmlrpc.fb.XMLRPCException;
import org.xmlrpc.fb.XMLRPCFactory;
