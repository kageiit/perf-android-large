...
import org.wp.fb.BuildConfig;
import org.wp.fb.R;
import org.wp.fb.WordPress;
import org.wp.fb.models.Blog;
import org.wp.fb.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.fb.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.fb.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.fb.ui.accounts.helpers.LoginAbstract;
import org.wp.fb.ui.accounts.helpers.LoginWPCom;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.fb.R.string.nux_cannot_log_in),
                getString(org.wp.fb.R.string.username_or_password_incorrect),
                org.wp.fb.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.fb.R.string.cancel), getString(
                        org.wp.fb.R.string.forgot_password), getString(
                        org.wp.fb.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.fb.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.fb.R.string.invalid_site_url_message) {
