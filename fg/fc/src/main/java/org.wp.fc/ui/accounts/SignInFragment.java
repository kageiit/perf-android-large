...
import org.wp.fc.BuildConfig;
import org.wp.fc.R;
import org.wp.fc.WordPress;
import org.wp.fc.models.Blog;
import org.wp.fc.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.fc.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.fc.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.fc.ui.accounts.helpers.LoginAbstract;
import org.wp.fc.ui.accounts.helpers.LoginWPCom;
...
import org.wp.fc.util.HelpshiftHelper.Tag;
import org.wp.fc.util.JSONUtils;
import org.wp.fc.util.NetworkUtils;
import org.wp.fc.util.StringUtils;
import org.wp.fc.util.ToastUtils;
import org.wp.fc.util.WPUrlUtils;
import org.wp.fc.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.fc.R.string.nux_cannot_log_in),
                getString(org.wp.fc.R.string.username_or_password_incorrect),
                org.wp.fc.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.fc.R.string.cancel), getString(
                        org.wp.fc.R.string.forgot_password), getString(
                        org.wp.fc.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.fc.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.fc.R.string.invalid_site_url_message) {
