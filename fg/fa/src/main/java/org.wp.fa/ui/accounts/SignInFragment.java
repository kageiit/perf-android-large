...
import org.wp.fa.BuildConfig;
import org.wp.fa.R;
import org.wp.fa.WordPress;
import org.wp.fa.models.Blog;
import org.wp.fa.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.fa.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.fa.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.fa.ui.accounts.helpers.LoginAbstract;
import org.wp.fa.ui.accounts.helpers.LoginWPCom;
...
import org.wp.fa.util.HelpshiftHelper.Tag;
import org.wp.fa.util.JSONUtils;
import org.wp.fa.util.NetworkUtils;
import org.wp.fa.util.StringUtils;
import org.wp.fa.util.ToastUtils;
import org.wp.fa.util.WPUrlUtils;
import org.wp.fa.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.fa.R.string.nux_cannot_log_in),
                getString(org.wp.fa.R.string.username_or_password_incorrect),
                org.wp.fa.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.fa.R.string.cancel), getString(
                        org.wp.fa.R.string.forgot_password), getString(
                        org.wp.fa.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.fa.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.fa.R.string.invalid_site_url_message) {
