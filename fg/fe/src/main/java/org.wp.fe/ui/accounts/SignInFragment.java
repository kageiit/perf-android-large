...
import org.wp.fe.BuildConfig;
import org.wp.fe.R;
import org.wp.fe.WordPress;
import org.wp.fe.models.Blog;
import org.wp.fe.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.fe.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.fe.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.fe.ui.accounts.helpers.LoginAbstract;
import org.wp.fe.ui.accounts.helpers.LoginWPCom;
...
import org.wp.fe.util.HelpshiftHelper.Tag;
import org.wp.fe.util.JSONUtils;
import org.wp.fe.util.NetworkUtils;
import org.wp.fe.util.StringUtils;
import org.wp.fe.util.ToastUtils;
import org.wp.fe.util.WPUrlUtils;
import org.wp.fe.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.fe.R.string.nux_cannot_log_in),
                getString(org.wp.fe.R.string.username_or_password_incorrect),
                org.wp.fe.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.fe.R.string.cancel), getString(
                        org.wp.fe.R.string.forgot_password), getString(
                        org.wp.fe.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.fe.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.fe.R.string.invalid_site_url_message) {
