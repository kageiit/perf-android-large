package org.wp.ff.ui.posts.services;
...
import org.wp.ff.models.PostLocation;
import org.wp.ff.models.PostStatus;
import org.wp.ff.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.ff.ui.posts.PostsListActivity;
import org.wp.ff.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.ff.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.ff.ui.prefs.AppPrefs;
import org.wp.ff.util.AppLog;
import org.wp.ff.util.AppLog.T;
import org.wp.ff.util.CrashlyticsUtils;
import org.wp.ff.util.DisplayUtils;
import org.wp.ff.util.ImageUtils;
import org.wp.ff.util.MediaUtils;
import org.wp.ff.util.StringUtils;
import org.wp.ff.util.SystemServiceFactory;
import org.wp.ff.util.WPMeShortlinks;
import org.wp.ff.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.ff.ApiHelper;
import org.xmlrpc.ff.ApiHelper.Method;
import org.xmlrpc.ff.XMLRPCClient;
import org.xmlrpc.ff.XMLRPCClientInterface;
import org.xmlrpc.ff.XMLRPCException;
import org.xmlrpc.ff.XMLRPCFactory;
