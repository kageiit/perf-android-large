...
import org.wp.ff.util.ServiceUtils;
...
public class MySiteFragment extends Fragment
        ...
        switch (requestCode) {
            ...
            case RequestCodes.EDIT_POST:
                ...
                if (resultCode == Activity.RESULT_OK
                        && getView() != null
                        && data != null
                        && data.getBooleanExtra("savedAsLocalDraft", false)) {
    ...
    private void refreshBlogDetails( final Blog blog) {
        if (!isAdded()) {
            return;
        }
    ...
    private void toggleAdminVisibility( final Blog blog) {
        if (blog == null) {
            return;
        }
    ...
    private boolean shouldHideWPAdmin( final Blog blog) {
        if (blog == null) {
            return false;
        }
