...
import org.wp.ff.BuildConfig;
import org.wp.ff.R;
import org.wp.ff.WordPress;
import org.wp.ff.models.Blog;
import org.wp.ff.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.ff.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.ff.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.ff.ui.accounts.helpers.LoginAbstract;
import org.wp.ff.ui.accounts.helpers.LoginWPCom;
...
import org.wp.ff.util.HelpshiftHelper.Tag;
import org.wp.ff.util.JSONUtils;
import org.wp.ff.util.NetworkUtils;
import org.wp.ff.util.StringUtils;
import org.wp.ff.util.ToastUtils;
import org.wp.ff.util.WPUrlUtils;
import org.wp.ff.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.ff.R.string.nux_cannot_log_in),
                getString(org.wp.ff.R.string.username_or_password_incorrect),
                org.wp.ff.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.ff.R.string.cancel), getString(
                        org.wp.ff.R.string.forgot_password), getString(
                        org.wp.ff.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.ff.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.ff.R.string.invalid_site_url_message) {
