...
import org.wp.o.BuildConfig;
import org.wp.o.R;
import org.wp.o.WordPress;
import org.wp.o.models.Blog;
import org.wp.o.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.o.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.o.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.o.ui.accounts.helpers.LoginAbstract;
import org.wp.o.ui.accounts.helpers.LoginWPCom;
...
import org.wp.o.util.HelpshiftHelper.Tag;
import org.wp.o.util.JSONUtils;
import org.wp.o.util.NetworkUtils;
import org.wp.o.util.StringUtils;
import org.wp.o.util.ToastUtils;
import org.wp.o.util.WPUrlUtils;
import org.wp.o.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.o.R.string.nux_cannot_log_in),
                getString(org.wp.o.R.string.username_or_password_incorrect),
                org.wp.o.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.o.R.string.cancel), getString(
                        org.wp.o.R.string.forgot_password), getString(
                        org.wp.o.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.o.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.o.R.string.invalid_site_url_message) {
