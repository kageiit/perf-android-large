...
import org.wp.q.BuildConfig;
import org.wp.q.R;
import org.wp.q.WordPress;
import org.wp.q.models.Blog;
import org.wp.q.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.q.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.q.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.q.ui.accounts.helpers.LoginAbstract;
import org.wp.q.ui.accounts.helpers.LoginWPCom;
...
import org.wp.q.util.HelpshiftHelper.Tag;
import org.wp.q.util.JSONUtils;
import org.wp.q.util.NetworkUtils;
import org.wp.q.util.StringUtils;
import org.wp.q.util.ToastUtils;
import org.wp.q.util.WPUrlUtils;
import org.wp.q.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.q.R.string.nux_cannot_log_in),
                getString(org.wp.q.R.string.username_or_password_incorrect),
                org.wp.q.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.q.R.string.cancel), getString(
                        org.wp.q.R.string.forgot_password), getString(
                        org.wp.q.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.q.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.q.R.string.invalid_site_url_message) {
