...
import org.wp.c.BuildConfig;
import org.wp.c.R;
import org.wp.c.WordPress;
import org.wp.c.models.Blog;
import org.wp.c.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.c.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.c.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.c.ui.accounts.helpers.LoginAbstract;
import org.wp.c.ui.accounts.helpers.LoginWPCom;
...
import org.wp.c.util.HelpshiftHelper.Tag;
import org.wp.c.util.JSONUtils;
import org.wp.c.util.NetworkUtils;
import org.wp.c.util.StringUtils;
import org.wp.c.util.ToastUtils;
import org.wp.c.util.WPUrlUtils;
import org.wp.c.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.c.R.string.nux_cannot_log_in),
                getString(org.wp.c.R.string.username_or_password_incorrect),
                org.wp.c.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.c.R.string.cancel), getString(
                        org.wp.c.R.string.forgot_password), getString(
                        org.wp.c.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.c.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.c.R.string.invalid_site_url_message) {
