...
import org.wp.z.BuildConfig;
import org.wp.z.R;
import org.wp.z.WordPress;
import org.wp.z.models.Blog;
import org.wp.z.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.z.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.z.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.z.ui.accounts.helpers.LoginAbstract;
import org.wp.z.ui.accounts.helpers.LoginWPCom;
...
import org.wp.z.util.HelpshiftHelper.Tag;
import org.wp.z.util.JSONUtils;
import org.wp.z.util.NetworkUtils;
import org.wp.z.util.StringUtils;
import org.wp.z.util.ToastUtils;
import org.wp.z.util.WPUrlUtils;
import org.wp.z.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.z.R.string.nux_cannot_log_in),
                getString(org.wp.z.R.string.username_or_password_incorrect),
                org.wp.z.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.z.R.string.cancel), getString(
                        org.wp.z.R.string.forgot_password), getString(
                        org.wp.z.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.z.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.z.R.string.invalid_site_url_message) {
