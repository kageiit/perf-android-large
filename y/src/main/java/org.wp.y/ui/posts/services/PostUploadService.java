package org.wp.y.ui.posts.services;
...
import org.wp.y.ui.notifications.ShareAndDismissNotificationReceiver;
import org.wp.y.ui.posts.PostsListActivity;
import org.wp.y.ui.posts.services.PostEvents.PostUploadEnded;
import org.wp.y.ui.posts.services.PostEvents.PostUploadStarted;
import org.wp.y.ui.prefs.AppPrefs;
import org.wp.y.util.AppLog;
import org.wp.y.util.AppLog.T;
import org.wp.y.util.CrashlyticsUtils;
import org.wp.y.util.DisplayUtils;
import org.wp.y.util.ImageUtils;
import org.wp.y.util.MediaUtils;
import org.wp.y.util.StringUtils;
import org.wp.y.util.SystemServiceFactory;
import org.wp.y.util.WPMeShortlinks;
import org.wp.y.util.helpers.MediaFile;
import org.xmlpull.v1.XmlPullParserException;
import org.xmlrpc.y.ApiHelper;
import org.xmlrpc.y.ApiHelper.Method;
import org.xmlrpc.y.XMLRPCClient;
import org.xmlrpc.y.XMLRPCClientInterface;
import org.xmlrpc.y.XMLRPCException;
import org.xmlrpc.y.XMLRPCFactory;
