...
import org.wp.y.BuildConfig;
import org.wp.y.R;
import org.wp.y.WordPress;
import org.wp.y.models.Blog;
import org.wp.y.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.wp.y.ui.accounts.helpers.FetchBlogListWPCom;
import org.wp.y.ui.accounts.helpers.FetchBlogListWPOrg;
import org.wp.y.ui.accounts.helpers.LoginAbstract;
import org.wp.y.ui.accounts.helpers.LoginWPCom;
...
import org.wp.y.util.HelpshiftHelper.Tag;
import org.wp.y.util.JSONUtils;
import org.wp.y.util.NetworkUtils;
import org.wp.y.util.StringUtils;
import org.wp.y.util.ToastUtils;
import org.wp.y.util.WPUrlUtils;
import org.wp.y.widgets.WPTextView;
...
//            track(Stat.LOGIN_FAILED, null);
    ...
    protected void showInvalidUsernameOrPasswordDialog() {
        ...
        nuxAlert = SignInDialogFragment.newInstance(getString(org.wp.y.R.string.nux_cannot_log_in),
                getString(org.wp.y.R.string.username_or_password_incorrect),
                org.wp.y.R.drawable.noticon_alert_big, 3, getString(
                        org.wp.y.R.string.cancel), getString(
                        org.wp.y.R.string.forgot_password), getString(
                        org.wp.y.R.string.contact_us), SignInDialogFragment.ACTION_OPEN_URL,
    ...
    protected void signInError(int messageId, String clientResponse) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        SignInDialogFragment nuxAlert;
        if (messageId == org.wp.y.R.string.username_or_password_incorrect) {
            ...
            return;
        } else if (messageId == org.wp.y.R.string.invalid_site_url_message) {
